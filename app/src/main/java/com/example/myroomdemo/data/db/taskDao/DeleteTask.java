...
public class DeleteTask  extends AsyncTask<Void, Boolean, Boolean> {
    ...
    public DeleteTask( TaskDao taskDao ,TodoModel model, TaskListener<Boolean> listener){
